...
trip_df[,end_time := {end_time[.N] = ping_time[.N]; end_time}, by = driver]
trip_df = trip_df[end_time > start_time, ]
trip_df[, trip_id := .I]
trip_df[, trip_time := as.integer(difftime(end_time, start_time, 
                                          units = "mins"))]
trip_df = trip_df[, .(trip_id, driver, start_time, end_time, trip_time, cum_mins)]
```
