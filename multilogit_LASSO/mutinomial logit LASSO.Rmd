...
Where the $p_i$ can be substituted by the expression in Equation \ref{eq:p}. The purpose of MLE is to maximize the log likelihood in Equation \ref{eq:LL} and obtain MLE estimates for $\beta_1, \beta_2, \cdots, \beta_k$.
